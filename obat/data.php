	...
	<div class="table-responsive">
		<table class="table table-hover table-striped">
			...
			<tbody>
				...
				$sql_obat = mysqli_query($conn, $query) or die(mysqli_error());
				if(mysqli_num_rows($sql_obat) > 0 ) {
					...
					<tr>
						...
						<td class="text-center">
							<a href="edit.php?id=<?= $data['id_obat']; ?>" class="btn btn-info"><i class="glyphicon glyphicon-edit"></i> Edit</a>
							<a href="del.php?id=<?= $data['id_obat']; ?>" class="btn btn-danger" onclick="return confirm('Yakin?')"><i class="glyphicon glyphicon-trash"></i> Del</a>
						</td>
					</tr>
				<?php
					}
